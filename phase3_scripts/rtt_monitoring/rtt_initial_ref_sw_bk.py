...
for key, val in link_dict.items():
    ...
    lb_array_1, lb_array_2 = np.split(link_dict[key]["lower_bd"], ref_split)
    median_array_1, median_array_2 = np.split(link_dict[key]["median"], ref_split)
    ub_array_1, ub_array_2 = np.split(link_dict[key]["upper_bd"], ref_split)
